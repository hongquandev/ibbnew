...
<script type="text/javascript" src="/modules/theblock/templates/js/paging_banner.en.js"></script>
...
<div style="width:100%">
    <script type="text/javascript">
		...
		session.add_link = '?module=theblock&action=add-banner&token={$token}';
