                    ...
                    <td align="left" valign="top" class="padding1">
                        <table width="100%" cellspacing="15">
                            <tr>
                                ...
                                <!--bar-->
                                	{include file = 'admin.help.bar.tpl'}
                                </td>
                                <td valign="top">
                                            ...
                                            {if isset($action)}
                                                <form method="post" action="{$form_action}" class="cmxform" name="frmCreate" id="frmCreate" enctype="multipart/form-data" >
                                                        ...
                                                        {if in_array($action,array('add-center','edit-center'))}
                                                            {include file='admin.help_center.form.tpl'}
                                                        {elseif in_array($action,array('add-cat','edit-cat'))}
                                                            {include file='admin.help_cat.form.tpl'}
                                                        {/if}
