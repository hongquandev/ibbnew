                                ...
                                <td valign="top">
                                    ...
                                    <table width="100%" cellspacing="0" class="box">
                                        ...
                                        {if isset($action)}
                                                  	<table width="100%">
                                                        <tr>
                                                            <td class="labelName"  id="gosPos" >
                                                                 <strong id="notify_title"> Postion :  <span class="require"></span></strong>
                                                            </td>
                                                            <td width="75%" class="value">
                                                                <select id="faq_id" name="fields[faq_id]"  style="width:20%"  > {$page} </select>
                                                            </td>
                                                            </tr>                                            
                                                        <tr>
                                                            <td class="labelName"  id="gosPos" style="margin-top:130px;" ><label for="Content"> Content Question : </label> </td>
                                                            <td width="75%" class="value"> <textarea id="question" name="fields[question]" rows="15" cols="80" style="width:100%" > </textarea> </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="labelName"  id="gosPos" style="margin-top:130px;" ><label for="Content"> Content Answer : </label> </td>
                                                            <td width="75%" class="value">	<textarea id="answer" name="fields[answer]" rows="15" cols="80" style="width:100%" > </textarea> </td>
                                                        </tr>
                                                     	<tr>
                                                     	</tr><tr>
                                                            <td colspan="2" align="right">
                                                               ...
                                                               <input type="button"  class="button" value="Create Content Faq" onClick="contentfaq.submit('#frmCreate');"/>
