                ...
                <div class="col-main" >
                    <div class="step-8-info">
                        ...
                        <div class="step-detail col2-set">
                            <div class="col-1">
                                <p style="">
                                    Thanks for using eBidda, your property will be posted live to the site after a quick content review and check.</br>
                            ...
                            <div class="col-2 bg-f7f7f7">
                                ...
                                <div class="areg-item">
                                    <div class="item">
                                        <div class="title" id="title-ps-ie7">
                                            <span class="f-left">{$review.info.title}</span>
                                            <span class="f-right">{$review.info.price}</span>
                                            <div class="clearthis clearthis-ie7">
                                            </div>
                                        </div>
                                        <div class="f-left info" id="f-left-ps-ie7" style="height: auto;">
                                            <div class="desc" style="margin-bottom: 15px;margin-top: 0px;">
                                            ...
                                            <div class="tbl-info">
                                                ...
                                                <ul id="ul-payment-success" class="f-left col2">
                                                    ...
                                                    <li class="payment-success {if $review.info.auction_sale_code == 'ebiddar'}ul-disable{/if}">
                                ...
                                <div>
                                    <ul style="margin-left: 50px; padding-bottom: 20px;">
