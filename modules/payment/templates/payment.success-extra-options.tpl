                ...
                <div class="col-main" style="float: left; width: 620px;">
                    <div class="step-8-info">
                        ...
                        <div class="step-detail col2-set">
                            <div class="col-1">
                                <p style="">
                                    Thanks for payment extra options. If you have any issues or concerns please contact us at <a href="mailto:{$contact_email}" style="font-size: 14px;font-weight: bold;">{$contact_email}</a>.
                                </p>
                                <br/>
                                <p>
                                </p>
