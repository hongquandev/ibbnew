    ...
    <tr>
        <td valign="top">
            ...
            <h2 style="font-size:12px; line-height:16px; margin:0;">
                Your property is synced from REAXML system successful.
            </h2>
            <p style="font-size:12px; line-height:16px; margin:0;">
                Thanks for using bidRhino, your property ís posted live to the site. Please check.
                <br>
            ...
            <p style="font-size:12px; line-height:16px; margin:0;">
                Your property information is below:
            </p>
        </td>
    </tr>
    <tr>
