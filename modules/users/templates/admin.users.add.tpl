...
<form method="post" action="index.php?module=users&action=list" name="frmCreate" id="frmCreate" enctype="multipart/form-data">
<br /> 
...
<tr  > 
    <td colspan=2 ><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <td align="center" valign="middle" style="padding:3px" bgcolor="#000000" class="bold12white">Add New User</td>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <td width="75%" style="width:300px;" ><input type="firstname" name="firstname" style="width:300px;"  class="required error" /></td>
  </tr> 
  <tr>
    <tr><td class="labelName" ><label for="Last Name"> Last Name : </label> </td>
    <td >
   <input type="lastname" name="lastname"  style="width:300px;" class="required error" />
    </td>
    </tr> 
    <tr>
         <td class="labelName" ><label for="Email"> Email : </label> </td>
         <td><input type="email" name="email"  style="width:300px;" class="required validate-email" /></td>
    </tr> 
    <tr>	
        <td class="labelName" ><label for="Telephone">Telephone : </label> </td>
        <td><input type="telephone" name="telephone" style="width:200px; margin-right:100px;" class="required validate-number" /></td>
    </tr>
    <tr>
    ...
    <option class="country" value="{$row.country}">Select... </option>
    ...
    <td width="25%"></td>
    <td width="75%">
    <input type="hidden" name="subadd" value="subadd" />
