<script src="/modules/config/templates/js/admin.js" type="text/javascript"></script>
<div style="width:100%">
<form  method="post" name="frmConfig" id="frmConfig" action="{$form_action}" enctype="multipart/form-data">
                    ...
                    <td align="left" valign="top" class="padding1">
                        <table width="100%" cellspacing="15">
                            <tr>
                                ...
                                <!--bar-->
                                	{include file = 'admin.configuration.bar.tpl'}
                                </td>
                                <td valign="top">
                                        ...
                                        <tr>
                                        	<td class="box-content">
                                                {if isset($action_ar[1])}
                                                    {include file = "admin.configuration.`$action_ar[1]`.tpl"}
                                                {else}
