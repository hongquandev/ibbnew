...
<table width="100%" cellspacing="10" class="edit-table">
    ...
    <tr>
        ...
        <td>
            <textarea name = "fields[schedule_rules_1]" id = "schedule_rules_1" class="input-text editor" style="width:100%;height:100px">{$form_data.schedule_rules_1}</textarea>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td>
            <textarea name = "fields[schedule_rules_2]" id = "schedule_rules_2" class="input-text editor" style="width:100%;height:100px">{$form_data.schedule_rules_2}</textarea>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td>
            <textarea name = "fields[schedule_rules_3]" id = "schedule_rules_3" class="input-text editor" style="width:100%;height:100px">{$form_data.schedule_rules_3}</textarea>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td>
            <textarea name = "fields[schedule_rules_4]" id = "schedule_rules_4" class="input-text editor" style="width:100%;height:100px">{$form_data.schedule_rules_4}</textarea>
        </td>
    </tr>
