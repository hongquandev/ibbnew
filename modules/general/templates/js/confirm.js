...
//POPUP CONFIRM
	...
	function showConfirm(error_to_from,url,form,type) {
        ...
        conf_popup.updateContainer('<div class="popup_container" style="width:'+width+'px;height: auto;min-height: 120px;z-index:1000"><div id="contact-wrapper">\
			 <div class="title"><h2 id="test-cufon"> This page says:<span id="btnclosex" class="btn-x" onclick="closeConfirm()">Close X</span></h2> </div>\
			 <div class="clearthis" style="clear:both;"></div>\
			 <div class="content content-po" id="confirm-msg">\
                 <img src="/modules/property/templates/images/alert.png"></img>\
		...
		*/
        conf_popup.updateContainer('<div class="popup_container" style="width:'+width+'px;height: auto;min-height: 120px;z-index:1000"><div id="contact-wrapper">\
			 <div class="title"><h2> This page says:<span id="btnclosex" class="btn-x" onclick="closeConfirm()">CLOSE X</span></h2></div>\
			 <div class="clearthis" style="clear:both;"></div>\
			 <div class="content content-po" id="confirm-msg">\
                 <img src="/modules/property/templates/images/alert.png"/>\
                <div class="msg-box" id="msg-confirm" style="display:none"></div><span style="font-weight: bold;">'+error_to_from+'</span></div>\
             </div>\
                <input type="hidden" id="url"/><input type="hidden" id="is_confirm" value="0"/>\
			 <div class="clearthis"></div><div class="center-confirm-button"><button class="btn-blue" id="OK" onclick="confirm_popup()" style="margin-right: 10px"><span><span>'+btn1+'</span></span></button>\
             <button class="btn-gray" onclick="closeConfirm()"><span><span>'+btn2+'</span></span></button></div>\
			  </div></div></div>');
