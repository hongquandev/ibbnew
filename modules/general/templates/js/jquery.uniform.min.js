    ...
    a.fn.uniform = function(k){
        ...
        function f(m){
            ...
            if (k.useID && m.attr("id") != "") {
                n.attr("id", k.idPrefix + "-" + m.attr("id"))
            }
            a(m).wrap(n);
            a(m).wrap(l);
            l = m.parent();
            ...
            a(m).css("opacity", 0).bind({
                "focus.uniform": function(){
                    n.addClass(k.focusClass)
                },
                "blur.uniform": function(){
                    n.removeClass(k.focusClass)
                },
                "click.uniform touchend.uniform": function(){
                    if (!a(m).attr("checked")) {
                ...
                "mousedown.uniform touchbegin.uniform": function(){
                    n.addClass(k.activeClass)
                },
                "mouseup.uniform touchend.uniform": function(){
                    n.removeClass(k.activeClass)
                },
                "mouseenter.uniform": function(){
                    n.addClass(k.hoverClass)
                },
                "mouseleave.uniform": function(){
                    n.removeClass(k.hoverClass)
                }
            });
            if (a(m).attr("checked")) {
                l.addClass(k.checkedClass)
            }
            if (a(m).attr("disabled")) {
                n.addClass(k.disabledClass)
            }
            b(m)
        }
        function c(m){
                    ...
                    if (a(this).is("select")) {
                        ...
                        if (a(this).is(":radio")) {
                            ...
                            if (a(this).is(":file")) {
                                ...
                                if (a(this).is("button, :submit, a, input[type='button']")) {
                                    a(this).unwrap().unwrap()
                                }
                            }
                        }
                            ...
                            if (l.is(":file")) {
                                ...
                                if (l.is(":text, :password, input[type='email']")) {
                                    ...
                                    if (l.is("textarea")) {
                                        ...
                                        if (l.is("a") || l.is(":submit") || l.is("button") || l.is("input[type=button]")) {
                                            i(l)
                                        }
                                    }
                                }
