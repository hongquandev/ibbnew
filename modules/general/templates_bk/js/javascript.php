...
require_once ROOTPATH.'/modules/general/templates/js/cufon/jquery.js';
...
if (!$mobileBrowser){
    require_once ROOTPATH.'/modules/general/templates/js/jquery.min.js';
...
/*require_once ROOTPATH.'/modules/property/templates/js/property.js';
require_once ROOTPATH.'/modules/agent/templates/js/loginpopup.js';*/
echo "\n";
