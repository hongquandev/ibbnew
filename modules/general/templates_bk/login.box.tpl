...
<form name="frmLogin" id="frmLogin" method="post" action="/index.php?module=agent&action=login" onsubmit="login('frmLogin');return false;">
                                    {if isset($authentic) and is_array($authentic) and count($authentic)>0 and $authentic.id > 0}
                                         <div class="showusername-field">
                                            ...
                                            <a style="color:#666666" href="/index.php?module=agent&action=view-dashboard">My Account</a>  &nbsp;| &nbsp;
                                    ...
                                    {else}
                                         <div class="username-field">
                                                ...
                                                <div class="button-field">
                                                    <input class="btn-login" type="submit" value=""/><input class="btn-register" type="button" value="" onclick="document.location='index.php?module=agent& action=landing'"/>
                                         </div>
                                    {/if}
</form>