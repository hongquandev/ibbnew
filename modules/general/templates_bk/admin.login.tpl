      ...
      <tr>
        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
			  ...
			  <form method="post" {literal}onsubmit="if (this.Username.value == '' || this.Password.value =='') { alert('{/literal}{$usersLang.loginMsg}{literal}'); return false;}" {/literal} name="loginForm" id="loginForm" action="index.php"  enctype="multipart/form-data">
