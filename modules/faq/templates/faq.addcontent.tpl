...
<form method="post" action="index.php?module=cms&action=add" class="cmxform" name="frmCreate" id="frmCreate" enctype="multipart/form-data" >
                                ...
                                <td valign="top">
                                    ...
                                    <table width="100%" cellspacing="0" class="box">
                                        ...
                                        <tr>
                                        	<td class="box-content">
                                                {if isset($action)}
                                                  		 <table  align="center" cellpadding="5">
                                                                <tr>
                                                                    <td class="labelName"  id="gosPos" >		 																			<strong id="notify_title">Page Title<span class="require">*</span></strong>
                                                                    </td>
                                                                  <td width="75%" class="value">	<input type="text" id="title" name="title"  class="validate-require" /> </td>
                                                                </tr>
                                                             
                                                                <tr>
                                                                    <td class="labelName"  id="gosPos" ><strong id="notify_title">Position<span class="require">*</span></strong> </td>
                                                                  <td width="75%" class="value"><input id="pos" name="pos" type="text"  size="5" class="validate-require" /> </td>
                                                                </tr>
                                                                 <tr>
                                                                    <td class="labelName"  id="gosPos" style="margin-top:130px;" ><label for="Content"> Content : </label> </td>
                                         ...
                                         <input type="button" class="button"  value="Create Page" onClick="cms.submit('#frmCreate');" />
