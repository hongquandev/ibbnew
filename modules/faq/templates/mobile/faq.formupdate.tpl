...
<form method="post" action="index.php?module=faq&action=edit&id={$row.faq_id}" class="cmxform" name="frmCreate" id="frmCreate" enctype="multipart/form-data"  >
                                                ...
                                                {if isset($action)}
                                                  	<table width="100%">
                                                        <tr>
                                                          ...
                                                          <td  class="value">
                                                          <input type="text" id="title" name="fields[title]" class="validate-require" style="width:80%" value="{$row.title}"  />
                                                          </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="value">
                                                             <input type="text" id="description" name="fields[description]" style="width:80%" value="{$row.description}"  />
                                                            </td>
                                                           </tr>   
                                                     <tr>
                                                        <tr>
                                                     ...
                                                     <tr>
                                                        ...
                                                        <td colspan="2" align="right">
                                                           ...
                                                           <input type="button"  class="button" value="Update Faq" onClick="faq.submit('#frmCreate');"/>
