<script type="text/javascript" src="../modules/report/templates/js/new_property.paging.js"></script>
{if $Admin.Level == 1}
...
<script type="text/javascript">
    var list_link = '../modules/report/action.admin.php?action=list-new_property&token={$token}';
</script>