<script type="text/javascript" src="../modules/report/templates/js/property_sold.paging.js"></script>
{if $Admin.Level == 1}
...
<script type="text/javascript">
    var list_link = '../modules/report/action.admin.php?action=list-property_sold&token={$token}';
</script>