<script type="text/javascript" src="../modules/report/templates/js/email_enquire.paging.js"></script>
{if $Admin.Level == 1}
...
<script type="text/javascript">
    var list_link = '../modules/report/action.admin.php?action=list-email_enquire&token={$token}';
</script>