                    ...
                    <div class="bg-f7f7f7">
                        <ul class="form-list">
                            <li class="fields">
                                <div class="field">
                                    <label>
                                        <strong id="notify_personal_firts_name">First Name <span >*</span></strong>
                                    </label>
                                    <div class="input-box">
                                ...
                                <div class="field">
                                    <label>
                                        <strong id="notify_personal_last_name">Last Name <span >*</span></strong>
                                    </label>
                                    <div class="input-box">
                            ...
                            <li class="wide">
                                <label>
                                    <strong id="notify_personal_street">Address <span >*</span></strong>
                                </label>
                                <div class="input-box">
                            ...
                            <li class="fields">
                                <div class="field">
                                    <label>
                                        <strong id="notify_personal_telephone">Telephone</strong>
                                    </label>
                                    <div class="input-box">
                                ...
                                <div class="field">
                                    <label>
                                        <strong id="notify_personal_mobilephone">Mobile Phone</strong>
                                    </label>
                                    <div class="input-box">
                            ...
                            <li class="wide">
                                <label>
                                    <strong id="notify_personal_license_number">Drivers License Number/Medicare Card No.</strong>
                                </label>
                                <div class="input-box">
