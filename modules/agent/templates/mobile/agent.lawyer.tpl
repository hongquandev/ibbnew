...
<div class="bar-title">
    <h2>MY LAWYER INFORMATION</h2>
</div>

<div class="ma-info mb-20px lawyer-main">
            ...
            <div>
             ...
             {/if}
                <ul class="form-list form-company">
                    ...
                    <li class="wide">
                        <label>
                            <strong>Company <span id="notify_company">*</span></strong>
                        </label>
                        <div class="input-box">
                            <input type="text" name="field[company]" id="company" value="{$form_data.company}" class="input-text validate-require" />
                        </div>
                    </li>
                    ...
                    <li class="wide">
                        <label>
                            <strong>Address <span id="notify_address">*</span></strong>
                        </label>
                        <div class="input-box">
                    ...
                    <li class="fields">
                       ...
                       <li class="wide" style="display:none">
                        ...
                        <div class="field" id="active_country">
                            <label>
                    ...
                    <li class="fields">
                         <div class="field" id="inactive_state">
                            <label>
                                <strong>State <span id="notify_state">*</span></strong>
                            </label>
                            <div class="input-box input-box-lawyer input-select">
                    	...
                    	<!-- End Change Text Suburb With Country is not Australia -->
                     	<div class="field">
                            ...
                            <div class="input-box input-box-lawyer input-select">
                                <select name="field[country]" id="country"  class="input-select validate-number-gtzero" onchange="onReloadCountry(this.form,'lawyer')">
                    ...
                    <li class="fields">
                        <div class="field">
                            ...
                            <div class="input-box">
                                <input type="text" name="field[telephone]" id="telephones" value="{$form_data.telephone}" class="input-text {*validate-require*} validate-telephone" />
                            </div>
                        </div>
                        <div class="field">
                            <label>
                                <strong>Mobilephone {*<span id="notify_mobiphone">*</span>*}</strong>
                            </label>
                            <div class="input-box">
                                <input type="text" name="field[mobilephone]" id="mobilephone" value="{$form_data.mobilephone}" class="input-text {*validate-require*} validate-telephone" />
                            </div>
                        </div>
                        <div class="clearthis">
                        </div>
                    ...
                    <li class="wide">
                        <label>
                            <strong>Email <span id="notify_email">*</span></strong>
                        </label>
                        <div class="input-box">
                ...
                <div class="buttons-set lawyer-buttons-set" id="button-set-myacc">
...
{literal}
<script type="text/javascript">
	onReloadCountry(document.getElementById("frmAgent"),'lawyer');
</script>
{/literal}