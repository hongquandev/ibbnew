    ...
    <div class="step-detail col2-set">
        ...
        <div class="bg-f7f7f7">
            <ul class="form-list form-register">
                ...
                <li class="wide">
                    <label>
                        <strong id="notify_lawyer_name">Lawyer Name</strong>
                    </label>
                    <div class="input-box">
                ...
                <li class="wide">
                    <label>
                        <strong id="notify_lawyer_company">Company Name</strong>
                    </label>
                    <div class="input-box">
                ...
                <li class="wide">
                    <label>
                        <strong id="notify_lawyer_address">Address</strong>
                    </label>
                    <div class="input-box">
                 ...
                 <li class="fields">
                   ...
                   <div class="field">
                        <label>
                            <strong id="notify_lawyer_suburb">Suburb</strong>
                        </label>
                        <div class="input-box">
                    ...
                    <div class="field">
                        <label>
                            <strong id="notify_lawyer_postcode">Postcode</strong>
                        </label>
                        <div class="input-box">
                ...
                <li class="fields">
                        ...
                        <div class="input-box">
                         {if $form_data.lawyer.other_state != '' or $form_data.lawyer.other_state == ''}
                                <select name="lawyer[state]" style="z-index:999;" id="lawyer_state"  class="" onchange="Common.validRegion('/modules/property/action.php?action=validate-property','#lawyer_suburb','#lawyer_state','#lawyer_postcode','#frmAgent')">
                                    {html_options options = $subState selected = $form_data.lawyer.state}
                                </select>
                           {else}
                                <select name="lawyer[state]" id="lawyer_state" style="z-index:999;" class="" onchange="Common.validRegion('/modules/property/action.php?action=validate-property','#lawyer_suburb','#lawyer_state','#lawyer_postcode','#frmAgent')">
                    ...
                    <!-- End Change Text Suburb With Country is not Australia -->
                        <div class="field">
                        <label>
                            <strong id="notify_lawyer_country">Country</strong>
                        </label>
                        <div class="input-box">
                           {* onchange="Common.changeCountry('/modules/general/action.php?action=get_states',this,'lawyer_state','#frmAgent')" *}
                            
                             <select name="lawyer[country]" style="z-index:999;" id="lawyer_country"  class="" onchange="onReloadCountryLawyer(this.form)" >
                ...
                <li class="wide">
                    <label>
                        <strong id="notify_lawyer_email">Email</strong>
                    </label>
                    <div class="input-box">
                        <input type="text" name="lawyer[email]" id="lawyer_email" value="{$form_data.lawyer.email}"  style="text-transform:lowercase;" class="input-text validate-email" autocomplete="off"/>
                    </div>
                </li>
                {*----*}
                ...
                <li class="wide">
                    <label>
                        <strong id="notify_contact_name">Contact Name <span >*</span></strong>
                    </label>
                    <div class="input-box">
                ...
                <li class="wide">
                    <label>
                        <strong id="notify_contact_address">Address <span >*</span></strong>
                    </label>
                    <div class="input-box">
                ...
                <li class="fields">
                    ...
                    <div class="field">
                        <label>
                            <strong id="notify_contact_suburb">Suburb <span >*</span></strong>
                        </label>
                        <div class="input-box">
                    ...
                    <div class="field">
                        <label>
                            <strong id="notify_contact_postcode">Postcode <span >*</span></strong>
                        </label>
                        <div class="input-box">
                ...
                <li class="fields">
                     <div class="field" id="inactive_state2">
                        <label>
                            <strong id="notify_contact_state">State <span >*</span></strong>
                        </label>
                        <div class="input-box">
                          {if $form_data.contact.other_state != '' or $form_data.contact.other_state == ''}
                                <select name="contact[state]" id="contact_state" style="z-index:999;" class="validate-number-gtzero" onchange="Common.validRegion('/modules/property/action.php?action=validate-property','#contact_suburb','#contact_state','#contact_postcode','#frmAgent')">
                    ...
                    <div class="field" id="inactive_country2">
                        <label>
                            <strong id="notify_contact_country">Country <span >*</span></strong>
                        </label>
                        <div class="input-box">
                        {* Common.changeCountry('/modules/general/action.php?action=get_states',this,'contact_state') *}
                            <select name="contact[country]" id="contact_country"  style="z-index:999;" class="  validate-number-gtzero" onchange="onReloadCountryContact(this.form,'')">
                ...
                <li class="fields">
                    <div class="field">
                        <label>
                            <strong id="notify_contact_telephone">Telephone</strong>
                        </label>
                        <div class="input-box">
                    ...
                    <div class="field">
                        <label>
                            <strong id="notify_contact_mobilephone">Mobile Phone</strong>
                        </label>
                        <div class="input-box">
                ...
                <li class="wide">
                    <label>
                        <strong id="notify_contact_email">Email <span >*</span></strong>
                    </label>
                    <div class="input-box">
                        <input type="text" name="contact[email]" id="contact_email"  style="text-transform:lowercase;" value="{$form_data.contact.email}" class="input-text validate-require validate-email" autocomplete="off"/>
                    </div>
                </li>                
                </form>
            </ul>
