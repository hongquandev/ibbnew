...
<div class="bar-title">
    <h2>{localize translate="MY LAWYER INFORMATION"}</h2>
</div>
            ...
            <div>
             ...
             {/if}
                <ul class="form-list form-company">
                    ...
                    <li class="wide">
                        <label>
                            <strong>{localize translate="Lawyer name"} <span id="notify_name">*</span></strong>
                        </label>
                        <div class="input-box">
                    ...
                    <li class="wide">
                        <label>
                            <strong>{localize translate="Company"} <span id="notify_company">*</span></strong>
                        </label>
                        <div class="input-box">
                    ...
                    <li class="fields">
                        ...
                        <div class="field">
                            <label>
                                <strong>{localize translate="Mobilephone"} {*<span id="notify_mobiphone">*</span>*}</strong>
                            </label>
                            <div class="input-box">
