                            ...
                            <div class="item">
                                <div class="f-left info" {*style="height:190px !important;"*}>
                                    <div class="title">
                                        ...
                                        <span class="f-left"><a href="{$property.info.link}" style="color: #CC8C04;">{$property.info.title}</a><span class="note-button" > </span></span>
                                    ...
                                    {elseif $property.info.type == 'forthcoming'}
                                        <div id="coll3" class="tbl-info tbl-info-new">
                                            ...
                                            {/if}
                                                <ul class="f-left col1" style="display: none;">
                                                    {if $property.info.type == 'auction'}
                                ...
                                <div class="f-right img" id="container_simg_{$property.info.property_id}">
                                    <div class="img-big-watermark">
                                        ...
                                        <a href="{$property.info.link}" style="" >
                                            ...
                                            <img id="img_mark_{$property.info.property_id}"  class="watermark" style="width:180px;height:130px;display: none;"/>
                                ...
                                <div class="f-right btn-ie7 div-list-boxx">
                                   ...
                                   {/if}
                                        ...
                                        {if !$property.info.confirm_sold}
                                            ...
                                            <button id="btn-offer-{$property.info.property_id}" class="btn-wht {$btn_offer_class}  btn-mao-ie7 btn-wht-list btn-offer" onclick="{$mao_str}">
