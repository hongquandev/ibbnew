...
<div class="register-application-content">
    <form name="frmAgentTransact" id="frmAgentTransact" method="post" action="{$form_action_transact}" enctype="multipart/form-data">
        ...
        <p>I have read and accepted the above declaration.
            <input style="margin-left: 5px;position: relative;top: 2px" id="accepted" type="checkbox" name="accepted"><label  style="display: none; color: red;margin-left: 20px" id="notify_accepted">Please check here. Thanks</label></p>
        ...
        <button style="margin-left: 20px" type="button" class="btn-blue-transact" onclick="submitApplication('#frmAgentTransact')">
