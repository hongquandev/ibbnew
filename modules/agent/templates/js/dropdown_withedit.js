function hiddenFields() {
	...
	document.getElementById("notify_mobilephone").style.display = "none";
...
function onReloadMemberPartner(form) {
	...
	if (val == 1  && toption == 1 || val == 2  && toption == 1 || val == 4 && toption == 1) {
		...
		*/
		...
		// Change Title
		//document.getElementById("Company detail").innerHTML = "Personal detail";
		//document.getElementById("Company information").innerHTML = "Lawyer information";
		//document.getElementById("Contact information").style.display = "block";
	...
	if (val == 1 || val == 2 || val == 4) {
		...
		*/
			...
			//document.getElementById("Company detail").innerHTML = "Company detail";
			//document.getElementById("Company information").innerHTML = "Company information";
			//document.getElementById("Contact information").style.display = "none";
