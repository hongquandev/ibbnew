...
<script type="text/javascript" src="/modules/note/templates/js/note.js"></script>
...
<link href="/modules/agent/templates/style/styles.css" type="text/css" rel="stylesheet"/>
