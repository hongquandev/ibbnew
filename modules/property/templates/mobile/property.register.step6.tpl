        ...
        <div class="col-2 bg-f7f7f7">
            <div class="areg-item">
                <div class="item">
                    ...
                    <div class="img" style="margin-left: 0;margin-top: 10px; margin-bottom: 10px">
                        <div>
                            <img src="{$review.photo}" alt="img" style="width:100%;height:130px;"/>
                        </div>
                    </div>
                    <div class="clearthis"></div>
                </div>
            ...
            <div id="panel_payment" class="panel-payment-step7" >
                ...
                <button id="step-eight-btn" class="btn-black step-eight-btn-red step-eight-btn3" onclick="(document.location.href='/?module=agent&action=view-property')"><span><span>Save</span></span></button>
                <button style="display: none;" class="btn-black step-eight-btn-red3" onclick="jQuery('#frmProperty').submit();">
