<script type="text/javascript" src="{$ROOTURL}/modules/general/templates/js/term.popup.js"></script>
<script type="text/javascript" src="{$ROOTURL}/modules/property/templates/js/property.js"></script>
<script type="text/javascript" src="{$ROOTURL}/modules/agent/templates/js/loginpopup.js" ></script>
<script src="{$ROOTURL}/utils/slide/slide-home.js" type="text/javascript"></script>
<script type="text/javascript" src="{$ROOTURL}/modules/general/templates/mobile/js/jquery.carouFredSel-6.2.1.js" ></script>

{*FOR FOCUS*}
{include file = "`$ROOTPATH`/modules/property/templates/mobile/property.home.focus.tpl"}
{*FOR LIVE*}
...
<script type="text/javascript">
    ...
    <div id="auctions-box" class="auctions-box auctions-box-live-home auctions-box-g">
        <div class="bar-title" id="bar-title-auction">
            <h2>LIVE AUCTIONS</h2>
            <a class="view-more view-all cufon" href="{$ROOTURL}/online-auctions.html">+</a>
            <div class="clearthis"></div>
        </div>
        <div id="sli">
            <div align="center">
                <img class="loading" style="height:40px;" src="/modules/general/templates/images/loading.gif" alt=""/>
            </div>
        </div>
        <div class="clearthis"></div>
    </div>
    <div id="forthcoming-box" class="property-box auctions-box auctions-box-live-home auctions-box-g " style="display:none;">
        <div class="bar-title" style="margin-top: 0;">
            <h2>FORTHCOMING AUCTIONS<a style="float:right;clear:none;" class="view-more view-more-forthcoming"
                                       href="{$ROOTURL}/forthcoming-online-auctions.html">+</a></h2>

            <div class="clearthis"></div>
        </div>
        <div id="sli2">
            <div>
                <img class="loading" style="height:30px;" src="/modules/general/templates/images/loading.gif" alt=""/>
            </div>
        </div>
        <div class="clearthis"></div>
    </div>
    <div id="sale-box" class="auctions-box auctions-box-live-home auctions-box-g" style="display:none">
        <div class="bar-title" style="position: relative ;">
            <h2>For Sale</h2>
            <a class="view-more view-all cufon" href="{$ROOTURL}/for-sale.html">+</a>
            <div class="clearthis"></div>
        </div>
        <div id="sli3">
            <div>
