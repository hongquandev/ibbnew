...
<div class="col-22">
    <ul class="form-list form-property">
        ...
        <li class="wide">
            ...
            <div class="input-box" id="pro_advertised_price_step2">
                <div style="margin-bottom: 15px">
                    ...
                    <br/>
                    From: <input type="text" style="width: 85px" value="{$form_data.show_advertised_price_from}" class="input-text" onkeyup="this.value=format_price(this.value,'#advertised_price_from_value','#pro_advertised_price_step2')"/>
                    &nbsp; - &nbsp;
                    To: <input type="text" style="width: 85px" value="{$form_data.show_advertised_price_to}" class="input-text" onkeyup="this.value=format_price(this.value,'#advertised_price_to_value','#pro_advertised_price_step2')"/>
        ...
        <li class="wide">
            {* advertised price*}
            <div class="input-box" id="pro_advertised_price_view">
                <div style="margin-bottom: 15px">
                    <label>
    ...
    <li style="list-style-type: none;">
        <div style="padding: 10px;">
            <div class="field">
                ...
                <div class="input-box">
                    <textarea name="fields[description]" id="description" class="input-select" style="height:250px;width:96%; padding: 0 3px;text-align: justify;">{$form_data.description}</textarea>
                </div>
            </div>
            <div class="clearthis">
            </div>
