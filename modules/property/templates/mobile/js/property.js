...
//    },
    ...
    downDoc: function (url) {
        document.location = url;
        jQuery('.lightbox-vmm-term').each(function () {
            jQuery(this).find('.contain-loading').remove();
        });
...
function showBidHistory(property_id, view, mode) {
    if (mode == null) {
        ...
        bh_popup.updateContainer('<div class="popup_container" style="position: relative;"><div id="contact-wrapper" class="contact-wrapper-bh" style="position: relative;">\
        ...
        if (mode == 'winner-info') {
            ...
            bh_popup.updateContainer('<div class="popup_container" style="position: relative;"><div id="contact-wrapper" class="contact-wrapper-bh" style="position: relative;">\
					 ...
					 <div class="content" style="max-height:700px" id="bh_container">\
					 </div></div></div>');
...
function showRegisterBid(property_id, action, title) {
    {
        ...
        bh_popup.removeChild();
        bh_popup.init({id: 'pro_popup', className: 'popup_overlay'});
        bh_popup.updateContainer('<div class="popup_container" style="position: relative;margin: 0 2px;"><div id="contact-wrapper" class="contact-wrapper-bh" syule="position: relative;">\
					 <div class="title"><h2> ' + title + ' <span id="btnclosex" onclick="bh_popup.hide()">x</span></h2></div>\
					 <div class="content" id="bh_container">\
					 </div></div></div>');
        Cufon.replace('h2');
...
sendfriend_popup.updateContainer('<div class="popup_container" style="width:300px"><div id="contact-wrapper">\
			...
			<div class="content" style="width:94%">\
				...
				<div class="input-box">\
				  ...
				  <input type="text" name="email_from" id="email_from" value="" class="input-text validate-require validate-email" style="width:100%"/>\
				</div>\
				<div class="input-box">\
				  <label for="subject"><strong id="notify_email_to">Email to <span >*</span></strong></label><br/>\
				  <input type="text" name="email_to" id="email_to" value="" class="input-text validate-require validate-email" style="width:100%"/>\
				</div>\
				<div class="input-box">\
...
contact_popup.updateContainer('<div class="popup_container" style="width:300px"><div id="contact-wrapper">\
...
Loading.prototype = {
    'show': function (div) {
        ...
        obj.append('<div class="contain-loading"><div class="small-loading"></div></div>');
        obj.find('.contain-loading').css({
            'z-index': '1000',
            'position': 'absolute',
            'background': 'white',
            'top': '0px',
        ...
        obj.find('.contain-loading .small-loading').css({
            'top': (obj.innerHeight() - jQuery('.small-loading').height()) / 2,
            'left': (obj.innerWidth() - jQuery('.small-loading').width()) / 2
        });
    },
    'hide': function (div) {
        var obj;
        ...
        obj.find('.contain-loading').remove();
    }
}
...
PropertyViewMore.prototype = {
    send: function (url, obj) {
        ...
        var info = jQuery.parseJSON(data);
        if (info.data) {
            jQuery(this.obj).html(info.data);
        } else {
            alert('failure');
        }
        console.log('onsend');
...
pvm.prepare = function () {
    ...
    loading.show(pvm.obj);
};
pvm.finish = function (data) {
    var info = jQuery.parseJSON(data);
    if (info.data) {
        jQuery(pvm.obj).html(info.data);
    } else {
        alert('failure');
    }
    loading.hide(pvm.obj);
};
//END
...
function show_confirm(url, msg, id, reg, type) {
    if (url == '') {
        ...
        new_url = url;
        property_id_Tr = id;
        confirm_delete_popup.updateContainer('<div class="popup_container" style="width:300px;height: 122px;min-height: 100px;"><div id="contact-wrapper">\
			 <div class="title"><h2 id="txtt"> This page says:<span id="btnclosex" onclick="close_confirm(\'' + reg + '\',' + type + ')">x</span></h2> </div>\
        ...
        if (jdata.confirm_sold == 1) {
            ...
            if (jdata.stop_bid == 1) {
                ...
                if (act == 'edit') {
                    ...
                    stop_bidding_popup.updateContainer('<div class="popup_container" style="width:300px;height: 122px;min-height: 100px;"><div id="contact-wrapper">\
...
function confirm_sold_mess(property_id, target_id, msg, ddl) {
    ...
    if (jQuery('#' + target_id).html() == 'Sold') {
        ...
        sold.updateContainer('<div class="popup_container" style="width:300px;height: 122px;min-height: 100px;"><div id="contact-wrapper">\
...
function showMess(error_to_from, url, show_ok_btn) {
    ...
    //height: 122px;
    mess_popup.updateContainer('<div class="popup_container" style="width:300px;height:auto;min-height: 120px;z-index:1000">\
...
function show_buynow_popup(property_id, buynow_price) {
    var msg = 'Please confirm you would like to buy this property now for ' + buynow_price;
    buynow_popup = new Popup();
    buynow_popup.init({id: 'buynow_popup', className: 'popup_overlay'});
    buynow_popup.updateContainer('<div class="popup_container" style="width:300px;height: 122px;min-height: 100px;"><div id="contact-wrapper">\
                ...
                onclick="confirm_buynow(' + property_id + ')"><span><span>OK</span></span></button>\
    ...
    if (result.success) {
        if (result.error) {
            ...
            if (!result.hasLoggedIn) {
                ...
                if (typeof result.payment_url != 'underfined') {
...
function openMAOGB(property_id) {
    ...
    MAOGB_popup.updateContainer('<div class="popup_container" style="width:450px"><div id="contact-wrapper">\
									 <div class="title"><h2 id="txtt"><span style="float:left;">Make An Offer Messages</span><span class="btn-x"  onclick="closeMAOGB()">Close X</span></h2></div>\
