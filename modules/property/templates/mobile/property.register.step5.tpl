...
<div class="step-6-info" id="step-6-info-info">
    ...
    <div class="step-detail col2-set">
                                        ...
                                        <li class="control">
                                            ...
                                            <strong class="strong-number-gtzero" style="float:left;{$part2}">
                                                ...
                                                {elseif $v.type == 'select'}
                                                    <select name="fields[term][{$k}]" id="{$v.code}" class="input-select {$v.is_valid_zero}" style="width:100%;">
        ...
        {if $readonly.end_time != 'readonly="readonly"' && !$isBlock && !($isAgent && $isAuction)}
            <script type="text/javascript">
                {literal}
                Calendar.setup({
                    inputField : 'end_time',
        ...
        {/if}
        {if $readonly.start_time != 'readonly="readonly"' && ($isBlock)}
            <script type="text/javascript">
                {literal}
                Calendar.setup({
                    inputField: 'date_to_reg_bid',
                    trigger: 'date_to_reg_bid',
                    onSelect: function () {
                        this.hide()
                    },
                    /*dateFormat : "%m/%d/%Y",*/
