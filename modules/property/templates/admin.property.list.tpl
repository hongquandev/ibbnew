<script type="text/javascript" src="../modules/property/templates/js/paging.en.js"></script>
...
{else}
    <table align="center" border="0" cellspacing="1" cellpadding="3">
        <tr>
            <td>
                <div class="message-box">You do not have permission to view this module.</div>
            </td>
        </tr>
    </table> 
{/if}
