...
<div class="buttons-col-1">
    ...
    {if !($property_data.info.list_price > 0) }
        {assign var = disabled_button_offer value = "disabled"}
    {/if}
    ...
    {else}
        {if ($property_data.info.buynow_buyer_id > 0)}
            {assign var = disabled_button_buynow value = "disabled"}
        {/if}
        {if $property_data.info.buynow_price == "\$0"}
            {assign var = disabled_button_buynow value = "disabled"}
        {/if}
...
<div class="buttons-col-2">
    ...
    <button onclick="return myReport(ROOTURL +'?module=property&action=print-detail&id={$property_data.info.property_id}')"
         class="btn-pv1 btn-pv-brochure" title="Brochure">
    </button>
    <button onclick="showPVM()" class="btn-pv1 btn-pv-legals" title="Legals">
    </button>
