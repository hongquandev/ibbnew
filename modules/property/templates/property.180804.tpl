...
{elseif eregi('^view',$action) or in_array($action, array('search', 'search-auction', 'search-sale', 'search-ebiddar','search-agent-auction','search-partner','search-agent','search-bid2stay'))}
	{include file="`$module`.view.tpl"}
{else}
