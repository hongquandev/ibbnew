...
if (isset($id)) :
	...
	<div style="float:left; margin-bottom:0px; width:100%" >
		...
		?>
			<img src="<?php echo ROOTURL;?>/modules/general/templates/images/ibb-logo.png" style="border:none" height="80" />
		<?php
		endif;
		?>
		...
		<div class="detail-2col">
			<div class="col1 f-left">
				...
				<div class="detail-imgs" style="margin:0px">
                   <img id="photo_main" src="<?php echo $row['file_name'];?>" alt="Photo" class="p-watermark-detail-big" style="width:600px"/>                
                	<?php
					/*
                    if (count($_imageAr) > 0) :
					?>
				...
				<div class="property-desc" style="margin-top:10px; width:600px">
					...
					<div><p><?php echo strlen($row['description']) > 500 ? substr($row['description'], 0, 500) .' ...': $row['description'];?></p></div>
				</div>
