...
<table width="100%" cellspacing="10" class="edit-table">
    ...
    <tr>
        ...
        <td>
            <input type="button" onclick="nodoc()" value="None upload document" class="button" style="margin-left: 148px; height: 18px; font-size: 10px;" />
        </td>
    </tr>
	<!--
	<tr>
    ...
    <tr>
    	<td width = "22%">
        	<strong id="notify_account_num">No. of sub accounts <span class="require">*</span></strong>
        </td>
        <td>
            <input type="text" name="account_num" id="account_num" value="{$form_data.account_num}" class="input-text validate-number disable-auto-complete" style="width:50%"/>
            <br/><i>* empty is unlimited</i>
        </td>
    </tr>
