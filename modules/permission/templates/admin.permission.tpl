<script src="/modules/permission/templates/js/admin.js" type="text/javascript"></script>

<div style="width:100%">
<form  method="post" name="frmPermission" id="frmPermission" action="{$form_action}">
                    ...
                    <td align="left" valign="top" class="padding1">
                        <table width="100%" cellspacing="15">
                            <tr>
                                ...
                                <!--bar-->
                                	{include file = 'admin.permission.bar.tpl'}
                                </td>
                                <td valign="top">
                                    ...
                                    <table width="100%" cellspacing="0" class="box">
                                        ...
                                        <tr>
                                        	<td class="box-content">
                                                {if isset($action)}
                                                    {include file = "admin.permission.`$action`.tpl"}
                                                {else}
